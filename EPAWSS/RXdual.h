// RXdual.h : Declaration of the CRXdual
...
class ATL_NO_VTABLE CRXdual :
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CRXdual, &CLSID_RXdual>,
	public IDispatchImpl<IRXdual, &IID_IRXdual, &LIBID_EPAWSSLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
BEGIN_COM_MAP(CRXdual)
	COM_INTERFACE_ENTRY(IRXdual)
