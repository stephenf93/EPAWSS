// TXdual.h : Declaration of the CTXdual
...
class ATL_NO_VTABLE CTXdual :
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CTXdual, &CLSID_TXdual>,
	public IDispatchImpl<ITXdual, &IID_ITXdual, &LIBID_EPAWSSLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
BEGIN_COM_MAP(CTXdual)
	COM_INTERFACE_ENTRY(ITXdual)
